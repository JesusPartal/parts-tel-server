import { BroadcastMessages, CameraState, ChatCommand, FFBCommand, PitCommand, ReloadTexturesCommand, ReplayPositionCommand, ReplaySearchCommand, ReplayStateCommand, TelemetryCommand, VideoCaptureCommand } from './defines.js';
interface BroadcastArgsMap {
    ...
    [BroadcastMessages.ChatCommand]: [command: ChatCommand.Macro, macroIdx: number] | [command: ChatCommand];
...
export type BroadcastCommandArgs<Command extends BroadcastCommand = BroadcastCommand> = BroadcastArgsMap[Command];
export {};
